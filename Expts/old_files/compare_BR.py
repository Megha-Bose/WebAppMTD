...
if __name__ == "__main__":
    ...
    plt.savefig(DIR + 'graphs/switch/switches_graph_BR.png', bbox_inches='tight')
    plt.clf()
    ...
    plt.title('Runtime')
    plt.legend(bbox_to_anchor=(1.05, 1))
    plt.savefig(DIR + 'graphs/runtime/runtimes_graph_BR.png', bbox_inches='tight')
    plt.clf()
    ...
    plt.title('Utilities')
    plt.legend(bbox_to_anchor=(1.05, 1))
    plt.savefig(DIR + 'graphs/utility/utilities_graph_BR.png', bbox_inches='tight')
