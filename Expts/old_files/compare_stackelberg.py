...
if __name__ == "__main__":
    ...
    for dataset_num in range(n_from, n_to):
        f = open(DIR + str(dataset_num) + "overall_out_stackelberg.txt")
    ...
    plt.savefig(DIR + 'graphs/switch/switches_graph_stackelberg.png', bbox_inches='tight')
    plt.clf()
    ...
    plt.title('Runtime')
    plt.legend(bbox_to_anchor=(1.05, 1))
    plt.savefig(DIR + 'graphs/runtime/runtimes_graph_stackelberg.png', bbox_inches='tight')
    plt.clf()
    ...
    plt.title('Utilities')
    plt.legend(bbox_to_anchor=(1.05, 1))
    plt.savefig(DIR + 'graphs/utility/utilities_graph_stackelberg.png', bbox_inches='tight')
