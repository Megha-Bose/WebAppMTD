...
if __name__ == "__main__":
    ...
    for eps in epsvec:
        ...
        plt.savefig('graphs/switch/switches_graph_'+str(int(eps*100))+'.png', bbox_inches='tight')
        plt.clf()
        ...
        plt.title('Runtime')
        plt.legend(bbox_to_anchor=(1.05, 1))
        plt.savefig('graphs/runtime/runtimes_graph_'+str(int(eps*100))+'.png', bbox_inches='tight')
        plt.clf()
        ...
        plt.title('Utilities')
        plt.legend(bbox_to_anchor=(1.05, 1))
        plt.savefig('graphs/utility/utilities_graph_'+str(int(eps*100))+'.png', bbox_inches='tight')
        plt.clf()
